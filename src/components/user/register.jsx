...
export default function Register() {
  ...
  const [messageEmailInvalid, setMessageEmailInvalid] =
    useState("Email không hợp lệ");
  const [messageUsernameInvalid, setMessageUsernameInvalid] = useState(
    "Vui lòng nhập nhập tên đăng nhập."
  );
  ...
  }, [name, phone, dob, email, gender, username, password, confirmPassword]);
          ...
          <div className="container px-5">
            ...
            <form>
              <div className="mb-3">
                ...
                />
                {isNameValid || !nameTouched ? null : (
                  <div className="invalid">Vui lòng nhập tên</div>
                )}
              ...
              <div className="mb-3 row">
                <div className="col-md-6">
                  ...
                  {isPhoneValid || !phoneTouched ? null : (
                    <div className="invalid">Số điện thoại không hợp lệ</div>
                  )}
                </div>
                <div className="col-md-6">
                  ...
                  {isDobValid || !dobTouched ? null : (
                    <div className="invalid">Vui lòng nhập ngày sinh</div>
                  )}
              ...
              <div className="mb-4">
                ...
                {isEmailValid || !emailTouched ? null : (
                  <div className="invalid">{messageEmailInvalid}</div>
                )}
              </div>
              <div className="mb-2">
                ...
                {isGenderValid || !genderTouched ? null : (
                  <div className="invalid">Vui lòng chọn giới tính</div>
                )}
              </div>
              <div className="mb-3">
                ...
                {isUsernameValid || !usernameTouched ? null : (
                  <div className="invalid mb-0">{messageUsernameInvalid}</div>
                )}
              ...
              <div className="mb-3">
                ...
                {isPasswordValid || !passwordTouched ? null : (
                  <div className="invalid">Vui lòng nhập mật khẩu</div>
                )}
              </div>
              <div className="mb-3">
                ...
                {isConfirmPasswordValid || !confirmPasswordTouched ? null : (
                  <div className="invalid">Vui lòng nhập lại mật khẩu</div>
                )}
              </div>
              <div className="mb-3 d-flex flex-column align-items-center">
                <br />
                <button
                  style={{ backgroundColor: "#644c38", borderRadius: 10 }}
                  type="submit"
          ...
          <div className="text-center mb-4">
            ...
            <div className="my-3">
              <button
                ...
                type="submit"
                className="btn px-5 me-3 border"
              >
                <img
      ...
      <Modal show={show} onHide={handleClose} size={"lg"} centered={true}>
        ...
        <Modal.Body>
          <div className={"center"}>
            ...
            <h5>Quên mật khẩu</h5>
            <span>
              Vui lòng cung cấp email đăng nhập, chúng tôi sẽ gửi mật khẩu reset
              về email của bạn.
            </span>
          </div>
