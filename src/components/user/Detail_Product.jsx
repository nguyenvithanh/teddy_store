...
export default function Detail_product() {
  ...
  const handleChange = (event) => {
    ...
    if (!isNaN(newQuantity) && newQuantity >= 1 && newQuantity <= (selectedSize ? selectedSize.quantity : Infinity)) {
          ...
          {products.map(products => (
            <div className="row ms-5 mt-3">
              <div key={products.id} className="col-6 col-lg-4">
                <img src={`/img_pro/${products.img_url}`} className='img-p' alt='' />
                <div className="image-gallery">
                  <div className="images">
                    {imageUrls.map((imageUrl, index) => (
                      <img key={index} src={`/img_pro/${imageUrl.img_url}`} alt='' />
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="col-6 col-lg-8 content_pro">
                  ...
                  ServicePro.map((ServicePro, index) => (
                    <div key={index} className="service">
                      ...
                      <div className="notesv">
                        ...
                        <input className="textt" type="text" placeholder=' Nội dung bạn muốn thêu' />
                        <div>
                          <p><hr /></p>
                          <p>Hoặc</p>
                          <p><hr /></p>
                ...
                <div className="cartt">
                  <div className="cart">
                  <button> <i className="bi bi-plus-square pe-2" ></i>Thêm vào giỏ hàng </button>
